          ...
          <Row>
            ...
            <Col md={6} style={{ float: "left", width: "62%" }}>
              ...
              <Card className={"card-1"}>
                ...
                <div style={{ color: "#34A59F", marginLeft: "220px" }}>
                  $1480
                </div>
              </Card>
            ...
            <Col md={4} style={{ float: "left" }}>
              <Card className={"card-5"}>
                ...
                <div style={{ opacity: "0.4" }}>
                  ...
                  <div style={{ marginLeft: "105px", marginTop: "-23px" }}>
                    |
                  </div>
                  <div style={{ marginLeft: "125px", marginTop: "-23px" }}>
                    by Robbin johnson
                  </div>
                ...
                <div>
                  <iframe
                    title="las-vegas, USA"
                    src="https://www.google.com/maps?q=Las%20Vegas%2C%20NV%2C%20USA&z=14&t=k&ie=UTF8&output=embed"
                    width="375"
                    height="300"
